...
import { FaShieldAlt, FaThumbsUp, FaRegClock, FaCar, FaStar } from 'react-icons/fa';
...
const STEPS = [
    { step: '01', title: 'Browse Our Fleet', desc: 'Explore our wide range of vehicles filtered by type, fuel, and transmission.' },
    { step: '02', title: 'Make a Booking', desc: 'Choose your dates, confirm your details, and submit your booking request.' },
    { step: '03', title: 'Hit the Road', desc: 'Booking confirmed — pick up your vehicle and enjoy the drive!' },
];
    ...
    return (
        <div className="flex flex-col bg-slate-900">
            ...
            <section className="relative flex flex-col items-center justify-center min-h-screen overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-950">
                ...
                <div className="container-app relative z-10 flex flex-col items-center text-center py-24">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-500/10 border border-amber-500/20 mb-8">
                        ...
                        <span className="text-amber-400 text-sm font-semibold tracking-wide">Pelmadulla's #1 Vehicle Rental</span>
                        <FaStar className="text-amber-400 text-xs" />
                    </div>

                    <h1 className="text-5xl sm:text-6xl lg:text-7xl font-extrabold text-white tracking-tight leading-[1.1] mb-6 max-w-5xl">
                        Find the Perfect Ride{' '}
                        <span className="text-amber-400">for Any</span>{' '}
                        Journey
                    </h1>

                    <p className="text-lg sm:text-xl text-slate-300 mb-10 max-w-2xl leading-relaxed">
                        Whether you need a compact car for city errands, a spacious van for a family trip, or a luxury SUV — we've got you covered with the best rates in town.
                    </p>

                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-20">
                        <Link to="/fleet" className="inline-flex items-center gap-2 w-fit px-8 py-4 sm:px-10 sm:py-5 bg-amber-500 hover:bg-amber-400 text-white font-bold text-lg rounded-2xl shadow-xl shadow-amber-500/30 transition-all hover:-translate-y-1">
                            Browse Our Fleet <FiArrowRight />
                        </Link>
                        <Link to="/signup" className="inline-flex items-center gap-2 w-fit px-8 py-4 sm:px-10 sm:py-5 bg-white/10 hover:bg-white/20 text-white font-semibold text-lg rounded-2xl border border-white/20 backdrop-blur-sm transition-all hover:-translate-y-1">
                            Create an Account
                        </Link>
                    </div>
            ...
            <section className="relative flex items-center justify-center min-h-screen bg-slate-900 border-t border-white/5 overflow-hidden">
                ...
                <div className="container-app py-20 w-full">
                    <Reveal className="flex flex-col items-center text-center mb-16 w-full mx-auto">
                        <span className="text-amber-500 text-sm font-bold uppercase tracking-widest">Why Choose Us</span>
                        ...
                        <p className="text-slate-400 mt-5 max-w-xl mx-auto text-lg text-center">
                            We pride ourselves on giving you a stress-free rental experience from start to finish.
                        </p>
                    </Reveal>
            ...
            <section className="relative flex items-center justify-center min-h-screen bg-slate-800/70 border-y border-white/5 overflow-hidden">
                ...
                <div className="container-app py-20 w-full">
                    <Reveal className="flex flex-col items-center text-center mb-16 w-full mx-auto">
                        <span className="text-amber-500 text-sm font-bold uppercase tracking-widest">Simple Process</span>
                        <h2 className="text-4xl sm:text-5xl font-extrabold text-white mt-3">
                            Book in{' '}
                            <span className="text-amber-400">3 Easy Steps</span>
                        </h2>
                        <p className="text-slate-400 mt-5 max-w-xl mx-auto text-lg text-center">
                            Getting on the road with us is quick, simple, and entirely hassle-free.
                        </p>
                    </Reveal>
                        ...
                        {STEPS.map((item, i) => (
                            <Reveal key={item.step} delay={i * 130}>
                                <div className="relative flex flex-col p-10 rounded-2xl bg-white/5 border border-white/10 hover:border-amber-500/30 hover:bg-white/10 transition-all duration-300 hover:-translate-y-2 h-full">
                                    <span className="text-8xl font-extrabold text-white/5 select-none mb-6 leading-none">{item.step}</span>
                                    ...
                                    <div className="absolute top-8 right-8 w-10 h-10 rounded-full bg-amber-500/10 border border-amber-500/20 flex items-center justify-center">
                                        <span className="text-amber-400 text-sm font-extrabold">{i + 1}</span>
                                    </div>
                                </div>
                            </Reveal>
                        ))}
            ...
            <section className="relative flex items-center justify-center min-h-screen bg-slate-900 border-t border-white/5 overflow-hidden">
                ...
                <div className="container-app py-20 w-full">
                    <Reveal className="flex flex-col items-center text-center mb-16 w-full mx-auto">
                        <span className="text-amber-500 text-sm font-bold uppercase tracking-widest">Top Picks</span>
                        <h2 className="text-4xl sm:text-5xl font-extrabold text-white mt-3">
                            Most <span className="text-amber-400">Popular</span> Vehicles
                        </h2>
                        <p className="text-slate-400 mt-5 max-w-xl mx-auto text-lg text-center">
                            Our most frequently booked vehicles — highly reliable and ready for the road.
                        </p>
                    </Reveal>
                ...
                <div className="container-app relative z-10 text-center py-20">
                    <Reveal className="flex flex-col items-center text-center w-full mx-auto">
                        ...
                        <p className="text-amber-100 text-xl mb-12 max-w-xl mx-auto text-center">
                            Sign up now and get instant access to our entire fleet at unbeatable prices.
                        </p>
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mt-8">
                            <Link to="/signup" className="inline-flex items-center justify-center w-fit px-8 py-4 sm:px-10 sm:py-5 bg-white text-amber-600 font-extrabold text-lg rounded-2xl shadow-2xl transition-all hover:-translate-y-1 hover:shadow-white/40">
                                Create Free Account
                            </Link>
                            <Link to="/fleet" className="inline-flex items-center justify-center w-fit px-8 py-4 sm:px-10 sm:py-5 bg-white/20 hover:bg-white/30 text-white font-semibold text-lg rounded-2xl border border-white/30 backdrop-blur-sm transition-all hover:-translate-y-1">
                                Browse Fleet First
                            </Link>
                        </div>
                    </Reveal>
