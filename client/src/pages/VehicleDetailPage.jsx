...
const VehicleDetailPage = () => {
  ...
  if (!vehicle) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-3">
        ...
        <Link to="/fleet" className="btn-primary !text-sm">
          Back to Fleet
        </Link>
      </div>
    );
  ...
  const validImages =
    vehicle.images?.length > 0 && !vehicle.images[0].includes("/vehicles/")
  ...
  return (
    <div className="min-h-screen">
      <div className="container-app lg:max-w-5xl py-8">
        ...
        <button
          onClick={() => navigate(-1)}
          className="flex items-center gap-1.5 text-slate-400 hover:text-white mb-6 text-sm transition-colors"
        >
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div>
            <div className="glass-card overflow-hidden mb-4 rounded-2xl border border-white/10 shadow-2xl">
              {validImages.length > 0 && !imgError ? (
                ...
                <div
                  className={`w-full h-64 sm:h-80 lg:h-96 bg-gradient-to-br ${bgGradient} flex items-center justify-center`}
                >
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-2 mb-3 flex-wrap">
              ...
              <span
                className={`px-3 py-1 rounded-full text-xs font-semibold shadow-sm border ${vehicle.available
            ...
            {vehicle.features?.length > 0 && (
              <div className="mb-8">
                <h3 className="text-white font-semibold text-sm uppercase tracking-wider mb-4 opacity-80">
                  Included Features
                </h3>
          ...
          <div className="mt-20 pt-10 border-t border-white/10">
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-2xl font-bold text-white">
                More <span className="gradient-text">{vehicle.category}</span>{" "}
                Options
              </h2>
              <Link
