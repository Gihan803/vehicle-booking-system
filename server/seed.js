  ...
  try {
    ...
    const vehicles = [
      // Alto category
      {
        ...
        description:
          "Compact and fuel-efficient Suzuki Alto, perfect for city driving around Pelmadulla and nearby areas.",
        available: true,
      },
      {
        ...
        description:
          "Upgraded Alto K10 with automatic transmission for a smoother ride.",
        available: true,
      },
      // WagonR category
      {
        ...
        description:
          "Spacious WagonR with excellent mileage. Great for family trips from Pelmadulla.",
        available: true,
      },
      {
        ...
        description:
          "Premium WagonR Stingray hybrid with push start and modern features.",
        available: true,
      },
      // Every category
      {
        ...
        plateNumber: "LB-5678",
        description:
          "Versatile Suzuki Every with ample space for passengers and luggage.",
        available: true,
      },
      {
        ...
        plateNumber: "LB-6789",
        description:
          "Premium Every Wagon with turbo engine and rear AC for maximum comfort.",
        available: true,
      },
      // Buddy category
      {
      ...
      // Premio category
      {
        ...
        plateNumber: "KE-8901",
        description:
          "Luxury Toyota Premio sedan with leather interior and premium features.",
        available: true,
      },
      {
        ...
        plateNumber: "KE-9012",
        description:
          "Well-maintained Toyota Premio, comfortable and reliable for long-distance travel.",
        available: true,
      },
      // Axio category
      {
        ...
        plateNumber: "KF-0123",
        description:
          "Fuel-efficient Toyota Axio hybrid. Lower running costs for longer trips.",
        available: true,
      },
      // Aqua category
      {
        ...
        plateNumber: "KG-1234",
        description:
          "Toyota Aqua — one of the most fuel-efficient vehicles for eco-friendly travel.",
        available: true,
      },
      {
        ...
        plateNumber: "KG-2345",
        description:
          "Stylish Aqua Crossover with raised ground clearance, great for Pelmadulla roads.",
        available: true,
      },
      // Prius category
      {
        ...
        plateNumber: "KH-3456",
        description:
          "Premium Toyota Prius with top-notch hybrid technology and luxury features.",
        available: true,
      },
      // Van category
      {
        ...
        plateNumber: "NC-4567",
        description:
          "Spacious Toyota KDH for large groups, pilgrimages, and tours from Pelmadulla.",
        available: true,
      },
      {
        ...
        plateNumber: "NC-5678",
        description:
          "Premium HiAce GL with dual AC and entertainment system for comfort travel.",
        available: true,
      },
      // SUV category
      {
        ...
        plateNumber: "SP-6789",
        description:
          "Powerful Toyota Prado 4WD SUV for adventure trips and off-road journeys.",
        available: true,
      },
    ];
